...
then
    vw --compressed -d data/vw_input/dev.sentence.${WEIGHT}.vw_input.gz --early_terminate 100 -k --ignore ${FEATURE} -q gt -b 28 --loss_function logistic -f data/models/sentence.full.${WEIGHT}.-${FEATURE}.vw
    ...
    vw --compressed -d data/vw_input/dev.sentence.${WEIGHT}.vw_input.gz --early_terminate 100 -k --ignore ${FEATURE} -q gt -q ga -b 28 --loss_function logistic -f data/models/sentence.full.${WEIGHT}.-${FEATURE}.vw
