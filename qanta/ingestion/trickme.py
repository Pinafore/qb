...
@click.option(
    "--expo-path", default="data/external/datasets/qanta.expo.2018.04.18.json"
)
...
@click.option(
    "--qanta-ds-path", default="data/external/datasets/qanta.mapped.2018.04.18.json"
)
@click.option(
    "--wiki-titles-path",
    default="data/external/wikipedia/wikipedia-titles.2018.04.18.json",
)
    ...
    with open(expo_in) as f:
        ...
        for q in questions:
            ...
            server_questions.append(
                {"question": text, "answer": answer, "qid": qid, "fold": fold}
            )
