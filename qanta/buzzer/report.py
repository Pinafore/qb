...
from qanta.buzzer.util import GUESSERS, load_protobowl, load_quizbowl
from qanta.buzzer.util import ultimate_buzzer
...
def report_ultimate():
    ...
    test_iter = QuestionIterator(all_guesses[c.BUZZER_DEV_FOLD], option2id,
            batch_size=128)
