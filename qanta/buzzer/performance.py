...
def load_data(preds, metas, q_db: QuestionDatabase) -> Sequence:
...
def generate(min_count, preds, metas, output):
    database = QuestionDatabase()
    # preds = load_predictions(pred_file)
    # metas = load_meta(meta_file)
    data = load_data(preds, metas, database)
